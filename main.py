...
def criar_interface():
    ...
    label_titulo = tk.Label(janela, text="Aperte o botão para falar", font=("Arial", 16), bg="#f0f0f0")
    label_titulo.pack(pady=20)

    def on_button_click():
        escutar_voz()

    botao_falar = tk.Button(janela, text="Falar", font=("Arial", 14), command=on_button_click, bg="#4CAF50", fg="white", width=20, height=2)
    botao_falar.pack(pady=20)

    label_info = tk.Label(janela, text="Clique para iniciar o reconhecimento de voz.", font=("Arial", 12), bg="#f0f0f0")
    label_info.pack(pady=10)

    botao_duvidas = tk.Button(janela, text="Não me conhece? Clique aqui", font=("Arial", 12), command=explicar_codigo, bg="#FF9800", fg="white", width=25, height=2)
    botao_duvidas.pack(pady=10)
